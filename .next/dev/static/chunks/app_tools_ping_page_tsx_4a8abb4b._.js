...
"[project]/app/tools/ping/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PingPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PingPage.useEffect": ()=>{
            ...
            if (countdown > 0) {
                timer = setTimeout({
                    "PingPage.useEffect": ()=>setCountdown(countdown - 1)
                }["PingPage.useEffect"], 1000);
            } else if (countdown === 0 && localStorage.getItem('ping_limit_expiry')) {
                localStorage.removeItem('ping_limit_expiry');
                window.location.reload();
            }
            return ({
                "PingPage.useEffect": ()=>clearTimeout(timer)
            })["PingPage.useEffect"];
        }
    }["PingPage.useEffect"], [
        countdown
...
_s(PingPage, "GSvC1BDPaGS3AwfAKbSrrcDkHLo=");
_c = PingPage;
var _c;
__turbopack_context__.k.register(_c, "PingPage");
...
//# sourceMappingURL=app_tools_ping_page_tsx_4a8abb4b._.js.map